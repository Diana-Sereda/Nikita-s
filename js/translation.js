var arrLang = {
  ...
  'ru': {
    ...
    'intro-p-6': ' Перед упаковкой и отправкой, каждое наше изделие проходит 3 основных этапа проверки качества с личным присутствием  (Основатель бренда Hit ‘Em Up).',
    'quote': '«Искусство - это не то, что хорошо выглядит, но то, что меняет нас»',
    'intro-p-7':'Именно через тканевое искусство, мы решили выразить свои эмоции, и философию Тупака Шакура. Просим Вас заметить, его взгл идеи об обществе в мире очень схожи с нашими.',
    'intro-p-8':'Самое главное, мы намерены возродить смысловую и историческую валюту в обществе , которая, к сожалению, затухает, на фоне происходящих событий во всемирной паутине.',
    'intro-p-9':'Это вещи, которые будут с вами как часть истории и искусства. Человек, не знающий своего прошлого, не сможет выстроить “светлое” будущее, поэтому мы ставим перед собой еще одну задачу – возрождения валюты чести и самое главное честности перед самим собой. Верность перед самим собой – это основа личности - это то что Вы покажете и расскажите своим потомкам.',
    'intro-p-10': 'Начиная с презинтации “All Eyez on Me ” все произведения идут с ограниченным тиражом, пронумерованным на изделии, вероятность рестока будет крайне мала',
    'parsing-text':'Здесь Вы сможете изучить заложенную историю, отсылки и пасхалки из жизни личностей, которых мы расположили и оформили на наши изделия.',
    ...
    'vegy-1':'В июне 1997 года в Лас-Вегасе состоялся реванш супер тяжеловесов Майка Тайсона и Эвандера Холифилда. ',
    'vegy-2':"Бой завершился дисквалификацией “Железного Майка”, он откусил усок уха Холифилду.",
    ...
    'trace':'Так же в артикле “The” от буквы “T” стекает след баллончика от краски – Данный объект показывает след баллончика от граффити – который олицетворяет: Бизнес и андеграунд / Деловитость и улица / Классика и хип-хоп / На оригинальном журнале этого нет.',
    'felon':'Тупак Шакур Рэп звезда, осуждённый преступник (тремя месяцами ранее Тупак был освобожден из-под стражи по делу об изнасиловании.  За него внесли залог в размере 1.4 млн$).',
    'murder':'Снуп Догг Рэп звезда, под судом (на момент публикации журнала, Снуп проходил по делу убийства бойца враждебной группировки Филиппа Волдемариама)',
